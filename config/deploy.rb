...
GITHUB_REPOSITORY_NAME = 'r12-team-312'
LINODE_SERVER_HOSTNAME = 'just-enother-team.r12.railsrumble.com'
...
after 'deploy:update_code' do
  # Setup Configuration
  run "rm #{release_path}/config/database.yml && cp #{shared_path}/config/database.yml #{release_path}/config/database.yml"
